...
__newFormat__<br>на новое значение формата изображения<br>
...
__filename__<br>Имя файла для скачивания изображения, включая расширение.
...
__format__<br>Формат файла изображения QR-кода.
